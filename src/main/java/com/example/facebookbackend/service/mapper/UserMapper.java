...
public class UserMapper {
    ...
    public static Map<String, AttributeValue> toMapCreate(User user) {
    ...
    public static UserResponse toMapGet(Map<String, AttributeValue> attributeValueMap) {
        ...
        postResponse.setName(attributeValueMap.get("name").s());
        return postResponse;
    }
    ...
    public static User convertByUserPrincipal(Map<String, AttributeValue> attributeValueMap) {
        ...
        user.setName(attributeValueMap.get("name").s());
        return user;
